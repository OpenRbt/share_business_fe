...
class _DebitState extends State<Debit> {
  ...
  ValueNotifier<bool> _isAcceptButtonPressed = ValueNotifier(false);
  ...
  Widget noSessionIdWidget(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) => _showRedirectAlert(context));
    return Container();
  }

  Future<Session?> _refreshSession(BuildContext context) async {
    if (sessionID != null) {
        int count = 0;
        while (count != 10){
          try {
            ...
            bonusBalance.value = wallet?.balance ?? 0;
            return session;
    ...
    _showRedirectAlert(context);
    return null;
  }

  final ValueNotifier<int> bonusBalance = ValueNotifier(0); //ValueNotifier
  int bonus = 0;
  final ValueNotifier<int> _currentSliderValue = ValueNotifier(0); //ValueNotifier
      ...
      builder: (context, snapshot){
        ...
        return Scaffold(
            ...
            body: sessionID != null
              ...
              future: _refreshSession(context),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ValueListenableBuilder(
                                    valueListenable: bonusBalance,
                                    builder: (context, bnsBlnc, _){
                                      return Text("Баланс бонусов: $bnsBlnc",
                              ...
                              onChanged: (text) {
                                if (text.isEmpty) {
                                  ...
                                  bonus = 0;
                                    ...
                                    int.parse(text) <= bonusBalance.value) {
                                  _currentSliderValue.value = int.parse(txt.text);
                                  bonus = _currentSliderValue.value;
                                } else if (int.parse(text) > bonusBalance.value){
                                  _currentSliderValue.value = bonusBalance.value;
                                  bonus = _currentSliderValue.value;
                                }
                              },
                          ...
                          Row(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      if (bonus > 0) {
                                        bonus--;
                                        _currentSliderValue.value = bonus;
                                        txt.text = bonus.toString();
                                      }
                                    },
                                    child: const Icon(
                              ...
                              ValueListenableBuilder(
                                  ...
                                  builder: (context, curSldVal, _){
                                    return SliderTheme(
                                        data: SliderStyles.moneyAmountSlider(),
                                        child: Slider(
                                          value: curSldVal.toDouble(),
                                          max: bonusBalance.value.toDouble(),
                                          divisions:
                                          bonusBalance.value == 0 ? 1 : bonusBalance.value,
                                          label: curSldVal
                                              .round()
                                              .toString(),
                                          onChanged: (double value) {
                                            _currentSliderValue.value = value.toInt();
                              ...
                              SizedBox(
                                  ...
                                  child: Container(
                                    ...
                                    child: ValueListenableBuilder(
                                      valueListenable: _isAcceptButtonPressed,
                                      builder: (context, btnPressed, _) {
                                        return ElevatedButton(
                                          style: btnPressed ? ButtonStyles.inactiveRedButton() : ButtonStyles.redButton(),
                                          onPressed: btnPressed ? null : () async {
                                            _isAcceptButtonPressed.value = true;
                                            try {
                                            ...
                                            _isAcceptButtonPressed.value = false;
                                          },
                                          child: Text(
                                            "Списать",
