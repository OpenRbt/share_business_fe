...
class WashServersApi {
  ...
  /// Performs an HTTP 'DELETE /wash-servers/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  Future<Response> deleteWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/wash-servers/{id}'
      .replaceAll('{id}', id);
  ...
  /// Performs an HTTP 'GET /wash-servers/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  Future<Response> getWashServerByIdWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/wash-servers/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<WashServer?> getWashServerById(String id,) async {
    final response = await getWashServerByIdWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'PATCH /wash-servers/{id}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [String] id (required):
  ///
  /// * [WashServerUpdate] body:
  Future<Response> updateWashServerWithHttpInfo(String id, { WashServerUpdate? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/wash-servers/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [WashServerUpdate] body:
  Future<WashServer?> updateWashServer(String id, { WashServerUpdate? body, }) async {
    final response = await updateWashServerWithHttpInfo(id,  body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
